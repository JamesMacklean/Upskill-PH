"""
Django settings for scholarium project.
...
ALLOWED_HOSTS = ['54.249.25.89', 'scholarium.io','127.0.0.1', 'api.scholarium.io', '185.229.113.4']
...
WSGI_APPLICATION = 'scholarium.wsgi.application'
